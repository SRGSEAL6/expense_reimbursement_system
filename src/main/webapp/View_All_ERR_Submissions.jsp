...
<Section class="p-3">
  ...
  <div class="container">
    <div class="text-center">   <!-- Add Search bar in order to view specific employees and fix columns--->
      <button class="btn btn-primary" id="viewSubmissions">View All Submissions</button>
      <button class="btn btn-warning" id="pendingRequests">View Pending Submissions</button> <!--- Current ---->
      <button class="btn btn-success" id="approvedRequests">View Approved Submissions</button> <!------Previous -->
      <button class="btn btn-danger" id="declinedRequests">View Declined Submissions</button> <!------Previous -->
    </div>
  </div>
</section>
